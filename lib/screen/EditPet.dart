...
class _EditPet extends State<EditPet> {
  ...
  TextEditingController longDescCtrl = TextEditingController(text: "");
        ...
        body: Container(
          ...
          child: ListView(
            children: [
              ...
              getTopTitle(S.of(context).longDescription),
              Container(
                height: containerHeightDes,
                decoration: getDecorations(),
                padding: getPadding(),
  ...
  Future<void> editPet() async {
    try {
      ...
      request.fields[LONG_DESC] = longDescCtrl.text.toString();
      request.fields[GENDER] = gender;
      request.fields[AGE] = ageCtrl.text.toString();
      request.fields[BREED] = breedCtrl.text.toString();
      request.fields[TYPE] = dropdownValue;
      request.fields[WEIGHT] = weightCtrl.text.toString();
      // request.fields[LONG_DESC]
      if (_image != null) {
