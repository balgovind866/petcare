...
extension colors on ColorScheme {
  ...
  static const Color primary = Color(0xffef0404);
  static const Color secondary = Color(0xffef0404);
  ...
  static const Color grad1Color = Color(0xffde5b5b);
  static const Color grad2Color = Color(0xffff4f4f);
